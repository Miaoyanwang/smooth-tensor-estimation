...
\begin{itemize}
%\item Long-term visiting fellow, Institute for Pure and Applied Mathematics (IPAM), UCLA. 03/2021-06/2021 (forthcoming). 
%\item UW-Madison nominee for Johnson and Johnson WiSTEM$^2$D scholar award in math discipline. Each University can nominate ONE candidate per discipline, 2019. 
...
\section*{Software}
\begin{itemize}
\item  $\bullet$ {\bf Tensor\_ordinal}: A set of R tools for noise reduction and completion from ordinal tensor data with possibly missing values. 
...
\item $\bullet$ {\bf Binary-Tensor}: R program for low-rank tensor estimation from binary observations.
